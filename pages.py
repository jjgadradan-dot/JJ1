...
const CHANGELOG=[
  ...
  {v:'v9.16',date:'۱۴۰۵/۰۵',title:'افزایش چشمگیر سرعت تونل (بافرها و تیونینگ سوکت)',items:[
    ...
    {t:'imp',x:'حذف فراخوانی throttle و قفل سشن از مسیر داغ دانلود XHTTP برای کانفیگ‌های بدون محدودیت سرعت (حالت رایج)'},
    {t:'imp',x:'سقف batch کوتای تطبیقی تا ۲MB و high-water جریان تا ۳۲MB برای دانلودهای حجیم'},
    {t:'imp',x:'سقف فریم WebSocket تا ۳۲MB و بک‌لاگ اتصال تا ۴۰۹۶ برای ترافیک هم‌زمان بیشتر'},
    {t:'imp',x:'بافر اولیهٔ توکن‌باکت محدودیت سرعت تا ۶۴KB برای شروع نرم‌تر ترافیک‌های محدودشده'},
  ]},
