...
const CHANGELOG=[
  ...
  {v:'v9.15',date:'۱۴۰۵/۰۵',title:'فرم کانفیگ کامل و موتور رلهٔ فوق‌سریع',items:[
    ...
    {t:'imp',x:'بهینه‌سازی بزرگ رله: حذف قفل سراسری از مسیر داده + حسابداری دسته‌ای مصرف هر ۱ ثانیه + حذف strftime از مسیر داغ (تا ۵ برابر سریع‌تر در میکروبنچمارک)'},
    {t:'imp',x:'تیونینگ سوکت TCP رله (TCP_NODELAY + بافرهای بزرگ‌تر) و فراخوانی throttle فقط برای کانفیگ‌های دارای محدودیت سرعت'},
  ]},
