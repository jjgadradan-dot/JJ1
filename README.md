...
* 🖥️ **مستر و نود همزمان**: هم می‌تواند پنل‌های RVG / Marzban / 3x-ui را به‌عنوان نود مدیریت کند، هم خودش با API توکن‌دار به یک پنل مستر دیگر وصل شود
...
* **مستر**: از منوی **نودها** پنل‌های RVG، Marzban و 3x-ui را اضافه کنید، وضعیت و کانفیگ‌ها را ببینید و ساب تجمیعی بگیرید (`/api/nodes-subscription`).
...
### اتصال این RVG به پنل مستر دیگر
...
4. اگر مستر هم RVG است، آدرس و رمز/توکن مستر را همین‌جا بدهید تا این نود خودش را آنجا ثبت کند.
...
RVG · پشتیبانی: [@Farajian2004f](https://t.me/Farajian2004f)
